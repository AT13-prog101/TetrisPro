...
public class GameOver {
    ...
    private static final int IMAGE_X_BOUND = 50;
    ...
    private static final int BUTTON_X_BOUND = 150;
    ...
    public void showGameOver(final JFrame frame, final Timer timer) {
        ...
        ImageIcon playAgainIcon = new ImageIcon(("user.dir") + ("\\resources\\playagain.png"));
     ...
     */
    public Interface playAgain(final JFrame frame, final Timer timer) {
        frame.dispose();
        timer.cancel();
